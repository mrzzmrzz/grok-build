...
use super::auth::{
    dispatch_cancel_login, dispatch_codex_login, dispatch_codex_logout, dispatch_login,
    dispatch_logout, dispatch_submit_auth_code, dispatch_switch_account,
};
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::CodexLogin => dispatch_codex_login(app),
        Action::CodexLogout => dispatch_codex_logout(app),
