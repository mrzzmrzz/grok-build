...
#[cfg(test)]
mod apple_terminal_ctrl_o_tests {
    use super::*;
    ...
    #[test]
    fn apple_terminal_idle_ctrl_o_toggles_yolo() {
        let mut agent = super::test_fixtures::make_agent();
        ...
        assert!(
            ...
            "idle Apple-Terminal Ctrl+O must toggle YOLO, got {outcome:?}"
        );
    }
    ...
    fn apple_terminal_running_ctrl_o_still_interjects() {
        ...
        assert!(
            ...
            "running + payload: interject must win, got {outcome:?}"
        );
    }
